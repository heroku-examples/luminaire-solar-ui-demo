...
export default function Prechat(props) {
  ...
  return (
    <div className="messagingPrechat">
      ...
      >
        <FormFields visiblePrechatFields={visiblePrechatFields} />
      </form>
      <button
        type="submit"
...
function FormFields({ visiblePrechatFields }) {
  ...
  const fields = visiblePrechatFields.map((field) => {
    return (
      <li className="prechatFormFieldContainer" key={field.name}>
        <p className="prechatFormFieldName">
          {field.name}
  ...
  return <ul className="prechatFormFieldsListView">{fields}</ul>;
}
...
function FormField({ field }) {
  ...
  if (
    field.type ===
      DEPLOYMENT_CONFIGURATION_CONSTANTS.SUPPORTED_PRECHAT_FORM_FIELDS
        .CHOICELIST &&
    field.choiceListId
  ) {
  ...
  switch (field.type) {
    ...
    case DEPLOYMENT_CONFIGURATION_CONSTANTS.SUPPORTED_PRECHAT_FORM_FIELDS
      .NUMBER:
    case DEPLOYMENT_CONFIGURATION_CONSTANTS.SUPPORTED_PRECHAT_FORM_FIELDS
      .CHECKBOX:
