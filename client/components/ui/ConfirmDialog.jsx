 ...
 * @param {string} [props.displayValue] - Value to display (e.g., URL being deleted)
 * @param {string} [props.confirmText='Remove'] - Confirm button text
      ...
      >
        ...
        <div className="flex gap-3 mt-6">
          <button
            ...
            onClick={onClose}
            disabled={loading}
            className="flex-1 px-4 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-40 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {cancelText}
          </button>
          <button
